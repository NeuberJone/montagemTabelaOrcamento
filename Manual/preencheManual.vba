Sub preencheManual()
    ...
    rng.Value = "Manual"                  ' Insere o texto na célula atualmente selecionada
    ...
    rng.Value = "Obs. Impressão"                     ' Insere o texto na célula atualmente selecionada

    Set rng = ws.Range("L16")           ' Define o intervalo de células a serem mescladas como objeto de intervalo
    rng.Value = "Info Adicional"                     ' Insere o texto na célula atualmente selecionada
